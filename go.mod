module github.com/peeweep/xcaddy-bin
...
require (
	...
	github.com/libdns/directadmin v0.3.1 // indirect
	...
	golang.org/x/crypto/x509roots/fallback v0.0.0-20240716182457-e983fa274187 // indirect
